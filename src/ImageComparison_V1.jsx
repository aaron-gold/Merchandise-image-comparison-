                      ...
                      <div className="comparisonImageBox">
                        {currentComparison.images[idx] ? (
                          <img
                            ...
                            loading="eager"
                            decoding="async"
                            // ✅ Fix #1 (regression): do NOT force CORS on <img>, otherwise it fails when server doesn't send CORS headers.
                            // removed: crossOrigin="anonymous"
                            // removed: referrerPolicy="no-referrer"
                            onError={(e) => {
                              console.warn("Failed to load image:", e.currentTarget.src);
                              e.currentTarget.alt = "Failed to load";
                              e.currentTarget.classList.add("imgFailed");
                              // NOTE: do NOT blank src; keeps debugging possible and avoids weird reflow.
                            }}
                          />
                        ) : (
